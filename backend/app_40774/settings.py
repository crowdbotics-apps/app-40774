"""
Django settings for app_40774 project.
...
WSGI_APPLICATION = 'app_40774.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_40774 API",
    "DESCRIPTION": "API documentation for app_40774 App",
    "VERSION": "v1",
}
